...
public class GameManager : MonoBehaviour, IDataPersistence
{
    ...
    public void DropPermaSeed(Vector3 position)
    {
        ...
        // If all the seeds of this difficulty have been dropped, return
        if (PermaSeedManager.Instance.HasDroppedAllSeedsOfRarity(Instance.activeRoom.GetDifficulty())) return;
